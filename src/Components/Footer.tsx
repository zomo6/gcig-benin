...
function Footer() {
    ...
    return (
        <div className="flex flex-col py-5 sticky  sm:px-12  bg-black text-white">
           <div className="sm:flex items-center justify-between ">
                <Image src="/logo.png" width={400} height={400} alt="pic" className="w-32 h-32 object-cover"/>

                <div className="sm:flex items-center sm:space-x-7 space-y-8 ml-6 sm:mt-0 mt-10">
                    ...
                    <div className="flex items-center sm:mt-7 sm:text-lg text-lg font-medium space-x-2"> 
                        <FaPhone className="rotate-90 text-2xl font-bold animate-bounce text-[#F39200]"/>
                         <div className="flex space-x-1"> <i>(+229) </i>  <i>01 9797 7303 </i> <i className="text-[#F39200]">/</i> <i>01 4646 4679</i> </div>
                     </div>

                    <div className="flex  space-x-2 items-center ml-3 text-lg sm:ml-0">
                        <FaEnvelope className="  font-bold animate-bounce text-[#F39200]"/> 
                        <p className="sm:text-xl  font-medium ">gcigbenin@gmail.com</p>
                    </div>
                </div>

                <ul className="flex mt-10 sm:mt-0 sm:ml-0 ml-10 sm:space-x-8 space-x-8 sm:text-3xl text-xl font-medium  ">
